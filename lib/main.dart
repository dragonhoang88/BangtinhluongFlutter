      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            //       labelText: 'Số ngày trên tháng trừ CN',
        ...
        onPressed: () {
          setState(() {
            ...
            num tinhcangay(num a, num b, num c) => a - b - c;
              // hàm tính nhanh có thể được sử dụng lại
            ...
            print('lương ngày công = ' + '$luongngaycong');
            lngaycong =
                NumberFormat.simpleCurrency(locale: 'vi-VN', decimalDigits: 0)
            ...
            print('lương tang ca ngày 150% = $luongtangcangay150');
            ...
            print('lương tăng ca ban đêm 210 = $luongtangcabandem210');
            ...
            print('tăng ca ngày nghỉ lễ = $Tangcangaynghilecn200');
            ...
            print('làm đêm ngày chủ nhật 230 = $Lamdemngaychunhat230');
            ...
            print('Tăng ca ban đêm ngày chủ nhật 270% = ' +
                '$Tangcabandemngaychunhat270');
            tc270 =
